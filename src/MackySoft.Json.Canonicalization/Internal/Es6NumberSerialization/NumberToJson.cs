...
{
    // This is the embedded entry point of the ES6-compatible JSON number serializer.
    // MackySoft modification: keep the embedded serializer outside the package's public API.
    internal static class NumberToJson
    {
         ...
         */
        internal static string SerializeNumber (double value)
        {
